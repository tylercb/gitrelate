    ...
    <footer className="bg-gray-100 dark:bg-gray-800 py-4 text-sm">
      <div className="container mx-auto px-4">
        ...
        <p className="max-w-2xl mx-auto text-center mt-4 text-xs text-gray-600 dark:text-gray-400">
          This dataset includes material that may be subject to third party rights. Query results are published under section 107
          of the Copyright Act of 1976; allowance is made for &quot;fair use&quot; for purposes such as criticism, comment,
          news reporting, teaching, scholarship, education and research. This website does not use cookies or analytics.
        </p>
